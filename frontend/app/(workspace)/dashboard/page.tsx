    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-[1.9fr_0.92fr]">
        <section className="glass-panel fade-up relative min-h-[30rem] overflow-hidden rounded-[28px] p-5 sm:p-6">
          ...
          <div className="relative z-10 mt-2 h-[24rem] w-full rounded-[24px] border border-card-border/70 bg-black/20 p-1">
            <GlobalHeatMap onCountrySelect={setSelectedCountry} />
          </div>
        </section>
